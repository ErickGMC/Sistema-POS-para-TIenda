...
contextBridge.exposeInMainWorld('electron', {
  ...
  obtenerProductosParaVenta: () => ipcRenderer.invoke('db:obtenerProductosParaVenta'),
  obtenerPresentacionesDeFamilia: (familiaId) => ipcRenderer.invoke('db:obtenerPresentacionesDeFamilia', familiaId),
  guardarFamiliaConPresentaciones: (familia, presentaciones) => ipcRenderer.invoke('db:guardarFamiliaConPresentaciones', { familia, presentaciones }),
